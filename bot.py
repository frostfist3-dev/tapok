...
def populate_initial_products():
    ...
    with sqlite3.connect(DB_FILE) as conn:
        ...
        FIXED_PRODUCTS = [
            ...
            #електронки
            ("Жыжа", "CANAPUFF HHC-P 1500МГ", "10мл", 2000),
            ("Одноразки PACKSPOD", "ХубаБуба", "1шт", 4000),
            ("Одноразки PACKSPOD", "Вишня Киви", "1шт", 4000),
            ("Одноразки PACKSPOD", "Ягодное Мороженое", "1шт", 4000),
            ("Одноразки PACKSPOD", "Банан", "1шт", 4000),
            ("Одноразки PACKSPOD", "Лимон с холодком", "1шт", 4000),
        ]
