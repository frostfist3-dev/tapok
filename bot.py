...
def populate_initial_products():
    """
    Заполняет таблицу 'products' данными из старого словаря,
    если таблица пуста.
    """
    with sqlite3.connect(DB_FILE) as conn:
        cursor = conn.cursor()
        ...
        if cursor.fetchone()[0] > 0:
            logging.info("Products table is already populated. Skipping initial data.")
            return # Не перезаписываем, если уже есть данные

        logging.info("Products table is empty. Populating initial data from OLD_PRODUCTS...")
        
        OLD_PRODUCTS = {
            "Шишки АК-47 (ИНДИКА)": { "1.0г": 400 },
            "Шишки АК-47 (ИНДИКА)": { "2.0г": 800 },
            "Шишки АК-47 (ИНДИКА)": { "3.0г": 1150 },
            "Шишки АК-47 (ИНДИКА)": { "4.0г": 1400 },
            "Шишки АК-47 (ИНДИКА)": { "5.0г": 1750 },
            "Шишки АК-47 (ИНДИКА)": { "7.0г": 2400 },
            "Шишки АК-47(САТИВА)": { "1.0г": 450 },
            "Шишки АК-47(САТИВА)": { "2.0г": 900 },
            "Шишки АК-47(САТИВА)": { "3.0г": 1250 },
            "Шишки АК-47(САТИВА)": { "4.0г": 1500 },
            "Шишки АК-47(САТИВА)": { "5.0г": 1850 },
            "Шишки АК-47(САТИВА)": { "7.0г": 2500 },
            "Гашиш АФГАН": { "1.0г": 500 },
            "Гашиш АФГАН": { "2.0г": 1000 },
            "Гашиш АФГАН": { "3.0г": 1450 },
            "Гашиш АФГАН": { "4.0г": 1900 },
            "Гашиш АФГАН": { "5.0г": 2350 },
            "Гашиш АФГАН": { "7.0г": 3000 },
            "Киф АФГАН": { "1.0г": 600 },
            "Киф АФГАН": { "2.0г": 1200 },
            "Киф АФГАН": { "3.0г": 1750 },
            "Киф АФГАН": { "4.0г": 2300 },
            ...
            "Амфетамин VHQ": { "2.0г": 1400 },
            "Амфетамин VHQ": { "3.0г": 2050 },
            "Амфетамин VHQ": { "4.0г": 2700 },
            "Амфетамин VHQ": { "5.0г": 3350 },
            "Амфетамин VHQ": { "7.0г": 4450 },
            "Мефедрон VHQ": { "1.0г": 700 },
            "Мефедрон VHQ": { "2.0г": 1400 },
            "Мефедрон VHQ": { "3.0г": 2050 },
            "Мефедрон VHQ": { "4.0г": 2700 },
            "Мефедрон VHQ": { "5.0г": 3350 },
            "Мефедрон VHQ": { "7.0г": 4450 },
            "Метадон Уличный": { "1.0г": 800 },
            "Метадон Уличный": { "2.0г": 1500 },
            "Метадон Уличный": { "3.0г": 2100 },
            "Метадон Уличный": { "4.0г": 2800 },
            "Метадон Уличный": { "5.0г": 3450 },
            "Метадон Уличный": { "7.0г": 4550 },
            "Экстази Домино": { "1 шт": 450 },
            "Экстази Домино": { "2 шт": 900 },
            "Экстази Домино": { "3 шт": 1250 },
            "Экстази Домино": { "4 шт": 1500 },
            "Экстази Домино": { "5 шт": 1850 },
            "Экстази Домино": { "7 шт": 2500 },
            "Грибы": { "1.0г": 450 },
            "Грибы": { "2.0г": 900 },
            "Грибы": { "3.0г": 1250 },
            "Грибы": { "4.0г": 1500 },
        ...
        for full_name, weights_dict in OLD_PRODUCTS.items():
            # Логика разделения: первое слово - Категория, остальное - Название
            ...
            if len(parts) == 2:
                ...
                # Для случаев типа "Грибы", "Гер", "Винт"
                category = full_name
            ...
            for weight, price in weights_dict.items():
                try:
                    ...
                    logging.error(f"Failed to migrate product {full_name}: {e}")
        
        conn.commit()
        logging.info("Initial products populated.")
