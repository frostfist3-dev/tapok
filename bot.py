...
def populate_initial_products():
    ...
    with sqlite3.connect(DB_FILE) as conn:
        ...
        FIXED_PRODUCTS = [
            ...
            #електронки
            ("Жыжа/Одноразки", "Жыжа CANAPUFF HHC-P Liquid 1.500МГ", "10мл", 2000),
            ("Жыжа/Одноразки", "Одноразка PACKSPOD-ХубаБуба", "1шт", 4000),
            ("Жыжа/Одноразки", "Одноразка PACKSPOD-Вишня Киви", "1шт", 4000),
            ("Жыжа/Одноразки", "Одноразка PACKSPOD-Ягодное Мороженое", "1шт", 4000),
            ("Жыжа/Одноразки", "Одноразка PACKSPOD-Банан", "1шт", 4000),
            ("Жыжа/Одноразки", "Одноразка PACKSPOD-Лимон с холодком", "1шт", 4000),
        ]
