...
ADMIN_IDS = [
    ...
    6928797177    # <<< ID ВТОРОГО АДМИНА.
]

# === НОВОЕ: Список карт для оплаты ===
PAYMENT_CARDS = [
    "5355 2800 2484 3821",  # Старая карта
...
def populate_initial_products():
    ...
    with sqlite3.connect(DB_FILE) as conn:
        ...
        FIXED_PRODUCTS = [
            ...
            ("Шишки", "Шишки АК-47 (ИНДИКА)", "2.0г", 750),
            ...
            ("Шишки", "Шишки АК-47 (САТИВА)", "2.0г", 850),
            ...
            ("Гашиш", "Гашиш АФГАН", "2.0г", 950),
            ("Гашиш", "Гашиш АФГАН", "3.0г", 1350),
            ("Гашиш", "Гашиш АФГАН", "5.0г", 2100),
            ("Гашиш", "Гашиш АФГАН", "7.0г", 2700),

            # Киф АФГАН
            ("Гашиш", "Киф АФГАН", "1.0г", 600),
            ("Гашиш", "Киф АФГАН", "2.0г", 1100),
            ("Гашиш", "Киф АФГАН", "3.0г", 1600),
            ("Гашиш", "Киф АФГАН", "5.0г", 2500),
            ("Гашиш", "Киф АФГАН", "7.0г", 3300),

            # Амфетамин VHQ
            ("Стимуляторы", "Амфетамин VHQ", "1.0г", 700),
            ("Стимуляторы", "Амфетамин VHQ", "2.0г", 1300),
            ("Стимуляторы", "Амфетамин VHQ", "3.0г", 1850),
            ("Стимуляторы", "Амфетамин VHQ", "5.0г", 2900),
            ("Стимуляторы", "Амфетамин VHQ", "7.0г", 3800),

            # Мефедрон VHQ
            ("Стимуляторы", "Мефедрон VHQ", "1.0г", 700),
            ("Стимуляторы", "Мефедрон VHQ", "2.0г", 1300),
            ("Стимуляторы", "Мефедрон VHQ", "3.0г", 1850),
            ("Стимуляторы", "Мефедрон VHQ", "5.0г", 2900),
            ("Стимуляторы", "Мефедрон VHQ", "7.0г", 3800),

            # Метадон Уличный
            ("Аптека", "Метадон Уличный", "1.0г", 800),
            ("Аптека", "Метадон Уличный", "2.0г", 1500),
            ("Аптека", "Метадон Уличный", "3.0г", 2150),
            ("Аптека", "Метадон Уличный", "5.0г", 3350),
            ("Аптека", "Метадон Уличный", "7.0г", 4400),

            # Экстази Домино
            ("Психоделики", "Экстази Домино", "1 шт", 450),
            ("Психоделики", "Экстази Домино", "2 шт", 850),
            ("Психоделики", "Экстази Домино", "3 шт", 1200),
            ("Психоделики", "Экстази Домино", "5 шт", 1850),
            ("Психоделики", "Экстази Домино", "7 шт", 2400),

            # Грибы
            ("Психоделики", "Грибы / Мушрум", "1.0г/шт", 450),
            ("Психоделики", "Грибы / Мушрум", "2.0г/шт", 850),
            ("Психоделики", "Грибы / Мушрум", "3.0г/шт", 1200),
            ("Психоделики", "Грибы / Мушрум", "5.0г/шт", 1850),
            ("Психоделики", "Грибы / Мушрум", "7.0г/шт", 2400),

            # ЛСД-300
            ("Психоделики", "ЛСД-300", "1 шт.", 500),
            ("Психоделики", "ЛСД-300", "2 шт", 950),
            ...
            ("Психоделики", "МДМА", "2.0г", 950),
            ("Психоделики", "МДМА", "3.0г", 1350),
            ("Психоделики", "МДМА", "5.0г", 2100),
            ("Психоделики", "МДМА", "7.0г", 2700),

            # Alfa pvp
            ("Стимуляторы", "Alfa pvp", "1.0г", 600),
            ("Стимуляторы", "Alfa pvp", "2.0г", 1100),
            ("Стимуляторы", "Alfa pvp", "3.0г", 1600),
            ("Стимуляторы", "Alfa pvp", "5.0г", 2500),
            ("Стимуляторы", "Alfa pvp", "7.0г", 3300),

            # Кетамин
            ("Аптека", "Кетамин", "1.0г", 500),
            ("Аптека", "Кетамин", "2.0г", 950),
            ("Аптека", "Кетамин", "3.0г", 1350),
            ("Аптека", "Кетамин", "5.0г", 2100),
            ("Аптека", "Кетамин", "7.0г", 2700),
            ...
            # Кокс
            ("Элита", "Кокс", "0.25г", 1000),
            ("Элита", "Кокс", "0.5г", 1900),
            ("Элита", "Кокс", "1.0г", 3500),
            ("Элита", "Кокс", "3.0г", 9500),
            ("Элита", "Кокс", "5.0г", 14500),
            ("Элита", "Кокс", "7.0г", 19000),

            # D-meth
            ("Элита", "D-meth", "0.25г", 600),
            ("Элита", "D-meth", "0.5г", 1100),
            ("Элита", "D-meth", "1.0г", 2000),
            ("Элита", "D-meth", "3.0г", 5500),
            ("Элита", "D-meth", "5.0г", 8500),
            ("Элита", "D-meth", "7.0г", 11000),
        ]
