...
def populate_initial_products():
    ...
    with sqlite3.connect(DB_FILE) as conn:
        ...
        FIXED_PRODUCTS = [
            ...
            ("Метадон", "Метадон Уличный", "2.0г", 1500),
